  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 font-sans">
      <div className="max-w-5xl w-full bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row-reverse">
        ...
        <div className="w-full md:w-1/2 bg-gradient-to-br from-[#FFD700] via-[#FFA500] to-[#FF8C00] p-8 md:p-12 flex flex-col justify-center text-white text-center md:text-left">
          ...
          <p className="text-orange-50 text-lg opacity-90 max-w-md mx-auto md:mx-0">
            Log in to access your wishlist, track orders, and discover personalized deals just for you.
          </p>
          ...
          <div className="hidden md:block mt-12 pt-8 border-t border-white/20">
            <div className="flex items-center gap-4">
              <div className="flex -space-x-3">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="w-10 h-10 rounded-full border-2 border-orange-400 bg-orange-100 flex items-center justify-center text-orange-600 text-xs font-bold">
                    U{i}
                  </div>
                ))}
              </div>
              <p className="text-sm font-medium">Join 10k+ active shoppers this week</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 lg:p-16">
          <div className="mb-10">
            <div className="flex items-center gap-2 mb-6 md:hidden">
               ...
               <span className="text-xl font-bold text-gray-900">ShopBright</span>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-xl border transition-all duration-200 outline-none focus:ring-2 focus:ring-[#FFA500] focus:border-transparent ${
                  errors.email ? 'border-red-500 bg-red-50' : 'border-gray-200 hover:border-[#FFA500]'
                }`}
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <a href="#" className="text-xs font-bold text-[#FFA500] hover:text-[#e69500] transition-colors">
                  Forgot password?
                </a>
              </div>
              <div className="relative">
                <input
                  ...
                  required
                  className={`w-full px-4 py-3 rounded-xl border transition-all duration-200 outline-none focus:ring-2 focus:ring-[#FFA500] focus:border-transparent ${
                    errors.password ? 'border-red-500 bg-red-50' : 'border-gray-200 hover:border-[#FFA500]'
                  }`}
                  placeholder="••••••••"
